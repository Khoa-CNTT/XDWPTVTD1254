                        ...
                        <div class="card-body">
                            <div class="border p-4 rounded">
                                <div class="text-center">
                                    ...
                                    <h4>Đăng nhập dành cho Chuyên Gia Tư Vấn</h4>
                                </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input v-model="tai_khoan.username" type="text" class="form-control border-end-0">
                                            </div>
                                        </div>
                                        <div class="col-12">
...
export default {
    ...
    methods: {
        dangNhap() {
            axios
                .post('http://127.0.0.1:8000/api/chuyen-gia/dang-nhap', this.tai_khoan)
                .then((res) => {
                    if(res.data.status == 1) {
                        
                        toaster.success(res.data.message);
                        this.$router.push('/chuyen-gia/tin-nhan')
                        localStorage.setItem('chia_khoa_16', res.data.chia_khoa);
                        localStorage.setItem('ten_chuyen_gia', res.data.ten_chuyen_gia);
